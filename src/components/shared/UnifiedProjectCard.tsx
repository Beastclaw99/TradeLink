              ...
              >
                ...
                <TabsContent value="milestones" className="mt-4">
                  <ProjectMilestones 
                    ...
                    onEditMilestone={onMilestoneUpdate ? onMilestoneUpdate : (() => Promise.resolve())}
                    onDeleteMilestone={onMilestoneDelete ? onMilestoneDelete : (() => Promise.resolve())}
                    onUpdateTaskStatus={onTaskStatusUpdate ? onTaskStatusUpdate : (() => Promise.resolve())}
                    projectId={project.id}
                    projectStatus={project.status || 'open'}
                  />
                </TabsContent>
